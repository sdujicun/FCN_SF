...
UCR46 = ['Adiac','Beef','Car','CBF','ChlorineConcentration','CinCECGtorso','Coffee','CricketX','CricketY','CricketZ','DiatomSizeReduction','ECGFiveDays','FaceAll','FaceFour','FacesUCR','FiftyWords','Fish','GunPoint','Haptics','InlineSkate','ItalyPowerDemand','Lightning2','Lightning7','Mallat','MedicalImages','MoteStrain','NonInvasiveFatalECGThorax1','NonInvasiveFatalECGThorax2','OliveOil','OSULeaf','Plane','SonyAIBORobotSurface1','SonyAIBORobotSurface2','StarLightCurves','SwedishLeaf','Symbols','SyntheticControl','Trace','TwoLeadECG','TwoPatterns','UWaveGestureLibraryX','UWaveGestureLibraryY','UWaveGestureLibraryZ','Wafer','WordSynonyms','Yoga']

UCR12 = ['Adiac','Beef','ChlorineConcentration','Coffee','DiatomSizeReduction','ItalyPowerDemand','Lightning7','MedicalImages','MoteStrain','Symbols','Trace','TwoLeadECG']

#UCR12 = ['Beef','ItalyPowerDemand','Coffee','TwoLeadECG','MoteStrain','DiatomSizeReduction','Symbols','Lightning7','Trace','MedicalImages','Adiac','ChlorineConcentration']
...
dataset_names_for_archive = {'UCRArchive_2018': UNIVARIATE_DATASET_NAMES_2018, 'UCR46':UCR46}
